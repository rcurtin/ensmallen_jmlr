...
Many frameworks or libraries for specific machine learnining approaches
...
Furthermore, custom behavior during optimization can be specified via {callback} functions,
