...
% When implementing an optimizer, we can
% assume that the given function to be optimized meets the required assumptions of the optimizers,
% and encode those requirements as compile-time checks (via {\tt static\_assert});
% this can provide much easier-to-understand error messages than typical compiler output for templated C++ code.
...
The experiments were ran on a MacBook Pro i7 2018 with 16GB RAM running macOS 10.14
