...
This includes many variants of Stochastic Gradient Descent \cite{TODO}
and Quasi-Newton optimizers \cite{TODO}.
...
%  \begin{tabular}{ccccccc}
        ...
        & & \rot{\scriptsize unified framework}
          ...
          & \rot{\scriptsize separable fns.~/~batches (TODO)}
            % 
...
(including some that use automatic differentiation)
